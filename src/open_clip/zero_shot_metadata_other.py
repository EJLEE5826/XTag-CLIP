...
SIMPLE_MEDICALMNIST_TEMPLATES = (
    lambda c: f'this is an image of {c}.',
    lambda c: f'{c} presented in image.',
    lambda c: f'a photo of {c}.',
    lambda c: f"A {c} photo",
)

SIMPLE_SCAR_TEMPLATES = (
    lambda c: f'A {c}',
    lambda c: f'this is an image of {c}.',
    lambda c: f'{c} presented in image.',
    lambda c: f'a photo of {c}.',
...
SCAR_CLASSNAMES = (
    "Others", "Hypertrophic scar", "Keloid scar",
)