...
def parse_args(args):
    ...
    parser.add_argument(
        "--batch-size", type=int, default=320, help="Batch size per GPU." # default=64
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--force-image-size', type=int, nargs='+', default=None,  # default=None
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help='Use fusion for the model. This is a flag to use the fused model.'
    )
