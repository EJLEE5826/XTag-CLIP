...
def create_model(
    ...
    if "add_learnable_tokens" in model_kwargs:
        add_learnable_tokens = model_kwargs.pop("add_learnable_tokens")
        n_learnable_tokens = model_kwargs.pop("n_learnable_tokens")
        insert_position = model_kwargs.pop("insert_position")
    else:
        add_learnable_tokens = None
        n_learnable_tokens = None
        insert_position = None
    # 
    # if "add_learnable_tokens" in model_kwargs:
    #     model_cfg["vision_cfg"]["add_learnable_tokens"] = model_kwargs.pop("add_learnable_tokens")
    #     if "n_learnable_tokens" in model_kwargs:
    #         model_cfg["vision_cfg"]["n_learnable_tokens"] = model_kwargs.pop("n_learnable_tokens")
    #     if "insert_position" in model_kwargs:
    #         model_cfg["vision_cfg"]["insert_position"] = model_kwargs.pop("insert_position")
    ...
    if add_learnable_tokens:
        model.visual.add_learnable_tokens = add_learnable_tokens
        if n_learnable_tokens is not None:
            model.visual.n_learnable_tokens = n_learnable_tokens
        if insert_position is not None:
            model.visual.insert_position = insert_position
        
        model.visual.add_token()
